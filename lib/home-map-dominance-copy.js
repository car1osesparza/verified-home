...
/** Resources page hero map band (same component as homepage). */
export const MAP_DOMINANCE_HEADLINE_RESOURCES = "Programs trust Verified to Find Athletes";
