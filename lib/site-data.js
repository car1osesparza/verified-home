...
export const HS_FOOTBALL = "High School Football";

/**
 * Sports routed to Patty Maye Ohanian for demo booking and About “your contact”.
 * Add labels exactly as they appear in `SPORTS` (PM to confirm the list).
 */
