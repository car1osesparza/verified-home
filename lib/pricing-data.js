...
/** 1-year list prices; 3-year uses DEFAULT_TRANSFER_TIERS. */
const STANDARD_ONE_YEAR_OVERRIDES = {
  Starter: "$1,300/year",
  "Starter+": "$2,225/year",
  Elite: "$2,400/year",
  Ultra: "$4,500/year",
...
export const GOLF_TENNIS_TIERS = [
  ...
  },
  {
    ...
    includes: ["Everything in Elite", "Pre-Portal Database"],
  },
];

export const LACROSSE_SWIM_WRESTLING_TIERS = [
  {
    name: "Elite",
    prices: { "3-year": "$825/year", "1-year": "$1,300/year" },
    includes: ["All D1 Transfers", "All D2 Transfers", "All D3 Transfers"],
  },
  {
    name: "Ultra",
    prices: { "3-year": "$1,700/year", "1-year": "$2,400/year" },
...
function tiersWithOneYearOverride() {
  return DEFAULT_TRANSFER_TIERS.map((tier) => ({
    ...tier,
    prices: {
      ...tier.prices,
      "1-year": STANDARD_ONE_YEAR_OVERRIDES[tier.name] ?? tier.prices["1-year"],
    },
  }));
}
...
const SPORT_PRICING = {
  ...
  Lacrosse: {
    layout: "elite-ultra",
    tiers: LACROSSE_SWIM_WRESTLING_TIERS,
    genderSplitNote: GENDER_SPLIT_NOTE,
  },
  "Swimming & Diving": {
    layout: "elite-ultra",
...
STANDARD_ONE_YEAR_SPORTS.forEach((sport) => {
  SPORT_PRICING[sport] = {
    layout: "four-tier",
    tiers: tiersWithOneYearOverride(),
    genderSplitNote: GENDER_SPLIT_NOTE,
  };
});
